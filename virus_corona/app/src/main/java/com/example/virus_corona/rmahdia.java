...
public class rmahdia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rmahdia);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rmahdia");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("mahdia").setValue(message);
