...
public class kassrine extends AppCompatActivity {
    ...
    DatabaseReference myRef=database.getReference("kassrine");
    // ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kassrine);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("rkassrine").push().setValue(message);
