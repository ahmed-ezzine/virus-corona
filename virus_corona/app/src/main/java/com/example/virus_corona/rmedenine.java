...
public class rmedenine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rmedenine);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rmedenine");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("medenine").setValue(message);
