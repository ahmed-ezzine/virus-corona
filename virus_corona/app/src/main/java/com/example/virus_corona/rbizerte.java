...
public class rbizerte extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rbizerte);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rbizerte");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("bizerte").setValue(message);
