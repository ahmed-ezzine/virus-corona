...
public class rjandouba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rjandouba);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rjandouba");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("jandouba").setValue(message);
