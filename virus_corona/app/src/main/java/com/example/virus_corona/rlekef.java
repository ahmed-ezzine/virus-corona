...
public class rlekef extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rlekef);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rlekef");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("lekef").setValue(message);
