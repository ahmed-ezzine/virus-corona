...
public class rmanouba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rmanouba);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rmanouba");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("manouba").setValue(message);
