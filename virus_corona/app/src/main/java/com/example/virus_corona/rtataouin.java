...
public class rtataouin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rtataouin);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rtataouin");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mDatabase.child("tataouin").setValue(message);
