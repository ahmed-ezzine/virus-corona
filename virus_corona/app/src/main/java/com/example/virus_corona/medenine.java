...
public class medenine extends AppCompatActivity {
    ...
    DatabaseReference myRef=database.getReference("medenine");
    // ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_medenine);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("rmedenine").push().setValue(message);
