...
public class rtunis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rtunis);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rtunis");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("tunis").setValue(message);
