...
public class rsidibouzid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rsidibouzid);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rsidibouzid");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("sidibouzid").setValue(message);
