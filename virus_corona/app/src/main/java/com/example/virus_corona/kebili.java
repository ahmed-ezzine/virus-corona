...
public class kebili extends AppCompatActivity {
    ...
    DatabaseReference myRef=database.getReference("kebili");
    // ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kebili);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("rkebili").push().setValue(message);
