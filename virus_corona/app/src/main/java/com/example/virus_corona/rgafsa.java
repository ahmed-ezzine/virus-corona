...
public class rgafsa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rgafsa);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rgafsa");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("gafsa").setValue(message);
