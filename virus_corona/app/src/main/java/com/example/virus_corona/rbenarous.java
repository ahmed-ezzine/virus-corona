...
public class rbenarous extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rbenarous);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rbenarous");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("benarous").setValue(message);
