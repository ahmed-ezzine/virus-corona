...
public class rsfax extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rsfax);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rsfax");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("sfax").setValue(message);
