...
public class siliana extends AppCompatActivity {
    ...
    DatabaseReference myRef=database.getReference("siliana");
    // ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_siliana2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("rsiliana").push().setValue(message);
