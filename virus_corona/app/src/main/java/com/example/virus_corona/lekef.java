...
public class lekef extends AppCompatActivity {
    ...
    DatabaseReference myRef=database.getReference("lekef");
    // ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lekef);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("rlekef").push().setValue(message);
