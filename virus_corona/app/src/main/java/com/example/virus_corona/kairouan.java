...
public class kairouan extends AppCompatActivity {
    ...
    DatabaseReference myRef=database.getReference("kairouan");
    // ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kairouan);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("rkairouan").push().setValue(message);
