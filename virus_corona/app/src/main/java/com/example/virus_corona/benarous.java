...
public class benarous extends AppCompatActivity {
    ...
    DatabaseReference myRef=database.getReference("benarous");
    // ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_benarous);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("rbenarous").push().setValue(message);
