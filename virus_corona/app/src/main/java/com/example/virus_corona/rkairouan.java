...
public class rkairouan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rkairouan);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rkairouan");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("kairouan").setValue(message);
