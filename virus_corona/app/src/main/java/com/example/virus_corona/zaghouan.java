...
public class zaghouan extends AppCompatActivity {
    ...
    DatabaseReference myRef=database.getReference("zaghouan");
    // ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zaghouan);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("rzaghouan").push().setValue(message);
