...
public class rsousse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rsousse);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rsousse");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mDatabase.child("sousse").setValue(message);
