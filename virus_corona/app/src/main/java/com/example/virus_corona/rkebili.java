...
public class rkebili extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rkebili);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rkebili");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("kebili").setValue(message);
