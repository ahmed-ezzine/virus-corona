...
public class rtozeur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rtozeur);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rtozeur");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mDatabase.child("tozeur").setValue(message);
