...
public class rsiliana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rsiliana);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rsiliana");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mDatabase.child("siliana").setValue(message);
