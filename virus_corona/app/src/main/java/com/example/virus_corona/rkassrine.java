...
public class rkassrine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rkassrine);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rkassrine");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("kassrine").setValue(message);
