...
public class rnabeul extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rnabeul);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rnabeul");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("nabeul").setValue(message);
