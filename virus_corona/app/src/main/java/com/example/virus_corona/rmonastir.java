...
public class rmonastir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rmonastir);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rmonastir");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("monastir").setValue(message);
