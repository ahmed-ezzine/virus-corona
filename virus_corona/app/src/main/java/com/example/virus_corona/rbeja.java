...
public class rbeja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rbeja);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rbeja");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("beja").setValue(message);
