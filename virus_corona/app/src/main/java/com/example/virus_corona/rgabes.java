...
public class rgabes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rgabes);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rgabes");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("gabes").setValue(message);
