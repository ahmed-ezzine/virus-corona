...
public class rzaghouan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rzaghouan);
        mRef=new Firebase("https://virus-coronaa.firebaseio.com/rzaghouan");
        ...
        ab3ath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("zaghouan").setValue(message);
